...
// GameObject instances in Galapagos.
...
// Game returns a pointer to the Galapagos Game instance
func (gameObjectImpl *GameObjectImpl) Game() galapagos.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = galapagosDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
